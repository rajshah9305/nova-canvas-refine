            ...
            {ITEMS.map((it, i) => (
              ...
              >
                <div className="md:text-right md:pr-10">
                  ...
                  <div className="mt-2 inline-block font-mono text-[10px] tracking-[0.25em] text-muted-foreground border border-foreground/20 px-1.5 py-0.5">
                    {it.tag}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="font-editorial text-primary text-base md:text-xl mt-1.5 mb-3">
                    {it.org}
                  </div>
